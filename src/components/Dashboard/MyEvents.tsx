    ...
    <main className="mw8 ml4-ns center">
      <article className="dt w-90 bb b--gray pb2 mt2">
        <div className="dtc w2 w3-ns v-mid">
          <img
            src="https://lh3.googleusercontent.com/proxy/IT--x73Y6OnE6BoroGgXiI7Nas1myZwbsnnFzhGxyac1n4X9dYw2n4cjjFtvKN-udKfzXtKzlcUqCI9hteVA3qoWHOQatgHkdgGPFJiG300Pur9IFOACWuSliVrM"
