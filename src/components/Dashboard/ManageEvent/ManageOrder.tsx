      ...
      <main className="mw9 ml4-ns center">
        ...
        <section className="w-100 ">
          <div className="bg-black-80">
                ...
                <tbody className="lh-copy f4-l f5-m f6">
                  {
                     (   <tr
                        ...
                        >
                          ...
                          <td className="pa1">
                            {getOrderTicketCount(ticket.cart)}
                          </td>
                          <td className="pa1">
                            {formatPrice(ticket.total.toString(), true)}
                          </td>
                        </tr>)
                  }
                </tbody>
            ...
            {Object.keys(ticket.cart).map(curr=>{
                const tickets = []
                for (var i=0;i<ticket.cart[curr].quantity;i++){
                    tickets.push(
                    <div className='mt3 pa3 bg-white black'>
                        ...
                        <div className="dtc-l dtc-m pl3-l pt1-m pb2 v-mid  fw7">
                            ...
                            <div
                            className={`f6-ns f7 fw6 pt1 mt1 mb0`}
                            >
                            Name
                            </div>
                            <div
                        ...
                        <div className="w-auto-m dtc" />
                            ...
                            <QRCode className='v-mid' value='http://www.socialticketing.com'  renderAs='svg' size={115}/>
                            <div className='tc'>{ticket.cart[curr].ticketNumber}</div>
                            </div>
                        </article>
